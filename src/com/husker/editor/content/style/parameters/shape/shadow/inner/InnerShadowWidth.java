...
public class InnerShadowWidth extends IntegerParameter {

    public InnerShadowWidth(String group) {
        super("Width", group);

        StyleParameterUtils.editHead(this, head -> {
            Predicate<XMLHead> predicate = h -> ("inner").equals(h.getParameterValue("type"));
