package com.husker.editor.window.panels.start;
            ...
            add(new WebPanel(){{
                ...
                add(new WebPanel(){{
                    ...
                    add(new WebPanel(){{
                        ...
                        add(new WebImage(Resources.getImageIcon("github_logo.png")){{
                        ...
                        add(new WebImage(Resources.getImageIcon("check_github.png")));
                        add(new WebImage(Resources.getImageIcon("weblaf_logo.png")){{
                            addMouseMotionListener(new MouseMotionAdapter() {
                                public void mouseMoved(MouseEvent e) {
                                    int range = 33;
                                    setCursor(Cursor.getPredefinedCursor(inRange(range, getSize(), e.getPoint()) ? Cursor.HAND_CURSOR : Cursor.DEFAULT_CURSOR));
